 ...
 * <ul>
 *   <li>{@link gov.nist.hla.script.impl.ObjectsImpl#getObjectClass <em>Object Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectsImpl extends MinimalEObjectImpl.Container implements Objects {
	...
	protected EClass eStaticClass() {
		return ScriptPackage.Literals.OBJECTS;
	}
	...
	public EList<ObjectClass> getObjectClass() {
		if (objectClass == null) {
			objectClass = new EObjectContainmentEList<ObjectClass>(ObjectClass.class, this, ScriptPackage.OBJECTS__OBJECT_CLASS);
		}
		return objectClass;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ScriptPackage.OBJECTS__OBJECT_CLASS:
