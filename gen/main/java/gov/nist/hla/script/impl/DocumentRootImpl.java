 ...
 *   <li>{@link gov.nist.hla.script.impl.DocumentRootImpl#getScript <em>Script</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
	...
	public Script getScript() {
		return (Script)getMixed().get(ScriptPackage.Literals.DOCUMENT_ROOT__SCRIPT, true);
	}
	...
	public NotificationChain basicSetScript(Script newScript, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(ScriptPackage.Literals.DOCUMENT_ROOT__SCRIPT, newScript, msgs);
	}
	...
	public void setScript(Script newScript) {
		((FeatureMap.Internal)getMixed()).set(ScriptPackage.Literals.DOCUMENT_ROOT__SCRIPT, newScript);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ScriptPackage.DOCUMENT_ROOT__SCRIPT:
